...
public extension Color {
    static let wmMain = Color("Main", bundle: .module)
    static let wmSecondary = Color("Secondary", bundle: .module)
    static let wmTranspBackground = Color("TranspBackground", bundle: .module)
